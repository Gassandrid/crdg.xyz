Components are the primary in game objects that can be used for building with [[Glue]]. There are a few sources of components, namely [[Component Machine]], [[Manifests]], [[Alien Summoning]], and [[Map]] items.
