    ...
    <div style="position:relative; display:flex; align-items:center; gap:10px; z-index:0; height:100%;">
        ...
        <div style="display:flex; flex-direction:column; justify-content:center; gap:4px;">
            ...
            <div style="display:flex; align-items:center; justify-content:center; gap:6px; font-size:1rem; font-style:italic; color:white;">
                ...
                <span style="background: rgba(255,0,0,0.4); border: 3px solid red; padding:2px 6px; border-radius:3px; color:white;">Trigger</span>
            </div>
        </div>
    </div>
</div>

The **Trigger** was once a [[content/Features/Manifests|Manifests]] item that can acquired through **Fishing** in a public or planting seeds in a [[Planter]] in a public server and waiting 24 hours. However, it has since been removed due to a lot of glitches with it.
