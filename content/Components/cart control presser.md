...
> > 
> > ![[wiki-1784575099533-586aed15-Screenshot 2026-07-20 151303.png|center]]
> > 
> > 
> 
> ### Component Info
...
The **Cart Control Presser** is a **Component** obtainable through the [[items/regular-items/component-machine|Component Machine]]. When the Cart Control Presser receives a signal, it will click anything clickable that is touching the red glowing end of the component. For example, it could click any button on a standard [[features/carts|Cart]] or it could toggle a [[components/tripwire|Tripwire]] or [[components/valve-pipe|Valve Pipe]].
