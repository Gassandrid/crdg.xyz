![Explosions from the game\'s
thumbnails.](Explosions.png "Explosions from the game's thumbnails.")
Explosions are effects that appear when certain actions are performed,
such as a [Jerry can](Jerry_can "Jerry can"){.wikilink} hitting the
...
- [The Emergency
  ...
  pressed.
- A [nuclear motor](nuclear_motor "nuclear motor"){.wikilink} is active
  too long.
- A fuel tank (from a [cart](Carts "cart"){.wikilink}) hits something
  too hard
