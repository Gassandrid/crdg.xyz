...
**!Hat** (roblox accessories' id)

These 2 are the same, you need to get id of any avatar item (for
example, 113948364816538 is for chicken shedletsky hat), and you will
get your item on your skin! **TIP: PRESS = ON PC TO DROP ALL YOUR
ACCESSOIRES**

**;Cakerbaker** (Private servers)

Spawns a new island from dealer, if u make a cake and eat it you will
get a small speed boost

**;Tycoon** (Private servers)

You can complete it for temporary rewards.
