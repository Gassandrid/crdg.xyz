...
When creating a new page, its name should be in sentence format (eg, "This is a sentence") rather than other cases (THIS IS A SENTENCE, This Is a Sentence, etc.). Pages that already have fully capitalized names are "grandfathered" and allowed to stay. If an existing page has the same name but is referring to a different subject, a link should be added to the start explaining that there are multiple possible uses, and whichever page is created second should have its name altered to reflect what it is referring to (eg, Subject (descriptor)). 
