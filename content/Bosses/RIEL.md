...
> | **Rewards** | - [[Flintlock]] ([[Glory]])- [[Marbles]] ([[Finality]]) - [[Waypoint Teleporter]] (private server only) - Access to [[QROT]] - [[Ipecac]] |
> | **Pronouns** | they / them |
> | **Date Added** | July 26th, 2022 |

## Description

**RIEL** is a boss added on July 26th, 2022 and is the second boss after [[Cart God]]. You have six lives, and losing all of them will kick you from the game for being "out of lives". Beating the boss awards the [[Flintlock]], [[Marbles]] (restricted to the [[Finality]]) badge), the [[Waypoint Teleporter]] (only in private servers), access to the [[QROT]] boss, and the [[Ipecac]] sword in the Boss Hub. Riel has two attack patterns, which is less than [[QROT]] and [[Cart God]], but Riel uses 9 attacks in the attack patterns giving Riel more attacks than [[Cart God]] and [QROT](https://crdg.xyz/bosses/qrot) .
...
> [!tip] Fun? Fact!
> Riel temporarily pauses the attack cycle before using Teleport Slash to walk towards players who have moved out of range. This usually applies when a player dies...
...
Using a well-timed macro to dodge for you seems to be an excellent strategy in theory. However, in practice, it becomes meaningless if the server lags behind even slightly: your perfect dodging streak, now stained by DEATH. (just dont use a macro.. its not worth it)
...
### Teleport Slash {#teleport\_slash}

### Continuous Beam {#continuous\_beam}

### Ground Slam {#ground\_slam}

### Following Orbs {#following\_orbs}
...
[[Marbles]] item, and access to fighting
[[QROT]]. You also get the Ipecac sword in
bosshub.

## General tips {#general\_tips}
